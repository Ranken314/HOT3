        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product
                {
                    ...
                    Image = "~/content/images/01-AeroFlo-ATB-Wheels.jpg",
                    Price = (decimal)189,
                    Qty = 40,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/02-Clear-Shade-85-T-Glasses.jpg",
                    Price = (decimal)45,
                    Qty = 14,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/03-Cosmic-Elite-Road-Warrior-Wheels.jpg",
                    Price = (decimal)165,
                    Qty = 22,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/04-Cycle-Doc-Pro-Repair-Stand.jpg",
                    Price = (decimal)166,
                    Qty = 12,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/05-Dog-Ear-Aero-Flow-Floor-Pump.jpg",
                    Price = (decimal)55,
                    Qty = 25,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/06-Dog-Ear-Cycle-Computer.jpg",
                ...
                new Product
                {
                    ...
                    Image = "~/content/images/07-Dog-Ear-Helmet-Mount-Mirror.jpg",
                    Price = (decimal)7.45,
                    Qty = 12,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/08-Dog-Ear-Monster-Grip-Gloves.jpg",
                    Price = (decimal)15,
                    Qty = 30,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/09-Eagle-FS-3-Mountain-Bike.jpg",
                    Price = (decimal)1800,
                    Qty = 8,
                    CategoryID = 2
                },
                new Product
                {
                    ...
                    Image = "~/content/images/10-Eagle-SA-120-Clipless-Pedals.jpg",
                ...
                new Product
                {
                    ...
                    Image = "~/content/images/11-Glide-O-Matic-Cycling-Helmet.jpg",
                ...
                new Product
                {
                    ...
                    Image = "~/content/images/12-GT-RTS-2-Mountain-Bike.jpg",
                    Price = (decimal)1650,
                    Qty = 5,
                    CategoryID = 2
                },
                new Product
                {
                    ...
                    Image = "~/content/images/13-HP-Deluxe-Panniers.jpg",
                    Price = (decimal)39,
                    Qty = 10,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/14-King-Cobra-Helmet.jpg",
                    Price = (decimal)139,
                    Qty = 30,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/15-Kool-Breeze-Rocket-Top-Jersey.jpg",
                    Price = (decimal)4.99,
                    Qty = 40,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/16-Kryptonite-Advanced-2000-U-Lock.jpg",
                    Price = (decimal)50,
                    Qty = 20,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/17-Nikoma-Lok-Tight-U-Lock.jpg",
                    Price = (decimal)33,
                    Qty = 12,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/18-ProFormance-ATB-All-Terrain-Pedal.jpg",
                    Price = (decimal)28,
                    Qty = 40,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/19-ProFormance-Toe-Klips-2G.jpg",
                    Price = (decimal)28,
                    Qty = 40,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/20-Pro-Sport-Dillo-Shades.jpg",
                    Price = (decimal)82,
                    Qty = 18,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/21-Road-Warrior-Hitch-Pack.jpg",
                    Price = (decimal)175,
                    Qty = 6,
                    CategoryID = 5
                },
                new Product
                {
                    ...
                    Image = "~/content/images/22-Shinoman-105-SC-Brakes.jpg",
                    Price = (decimal)23.50,
                    Qty = 16,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/23-Shinoman-Deluxe-TX-30-Pedal.jpg",
                    Price = (decimal)45,
                    Qty = 60,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/24-Shinoman-Dura-Ace-Headset.jpg",
                    Price = (decimal)67.50,
                    Qty = 20,
                    CategoryID = 4
                },
                new Product
                {
                    ...
                    Image = "~/content/images/25-StaDry-Cycling-Pants.jpg",
                    Price = (decimal)69,
                    Qty = 22,
                    CategoryID = 3
                },
                new Product
                {
                    ...
                    Image = "~/content/images/26-TransPort-Bicycle-Rack.jpg",
                    Price = (decimal)27,
                    Qty = 14,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/27-Trek-9000-Mountain-Bike.jpg",
                    Price = (decimal)1200,
                    Qty = 6,
                    CategoryID = 2
                },
                new Product
                {
                    ...
                    Image = "~/content/images/28-True-Grip-Competition-Gloves.jpg",
                    Price = (decimal)22,
                    Qty = 20,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/29-Turbo-Twin-Tires.jpg",
                    Price = (decimal)29,
                    Qty = 18,
                    CategoryID = 6
                },
                new Product
                {
                    ...
                    Image = "~/content/images/30-Ultimate-Export-2G-Car-Rack.jpg",
                    Price = (decimal)180,
                    Qty = 8,
                    CategoryID = 5
                },
                new Product
                {
                    ...
                    Image = "~/content/images/31-Ultra-2K-Competition-Tire.jpg",
                    Price = (decimal)34,
                    Qty = 22,
                    CategoryID = 6
                },
                new Product
                {
                    ...
                    Image = "~/content/images/32-Ultra-Pro-Rain-Jacket.jpg",
                    Price = (decimal)85,
                    Qty = 30,
                    CategoryID = 3
                },
                new Product
                {
                    ...
                    Image = "~/content/images/33-Victoria-Pro-All-Weather-Tires.jpg",
                    Price = (decimal)54.95,
                    Qty = 20,
                    CategoryID = 6
                },
                new Product
                {
                    ...
                    Image = "~/content/images/34-Viscount-C-500-Wireless-Bike-Computer.jpg",
                    Price = (decimal)49,
                    Qty = 30,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/35-Viscount-CardioSport-Sport-Watch.jpg",
                    Price = (decimal)179,
                    Qty = 12,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/36-Viscount-Microshell-Helmet.jpg",
                    Price = (decimal)36,
                    Qty = 20,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/37-Viscount-Mountain-Bikes.jpg",
                    Price = (decimal)635,
                    Qty = 5,
                    CategoryID = 2
                },
                new Product
                {
                    ...
                    Image = "~/content/images/38-Viscount-Tru-Beat-Heart-Transmitter.jpg",
                    Price = (decimal)47,
                    Qty = 20,
                    CategoryID = 1
                },
                new Product
                {
                    ...
                    Image = "~/content/images/39-Wonder-Wood-Cycle-Socks.jpg",
                    Price = (decimal)19,
                    Qty = 30,
                    CategoryID = 3
                },
                new Product
                {
                    ...
                    Image = "~/content/images/40-X-Pro-All-Weather-Tires.jpg",
                    Price = (decimal)24,
                    Qty = 20,
                    CategoryID = 6
                }
